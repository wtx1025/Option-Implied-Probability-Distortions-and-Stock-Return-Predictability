...
% there are three places to change when using different predictors 
mergedData = [monthlyLastData, data(:, {'b_m'})]; % merge monthlyLastData & data 
...
benchmark_prediction_OOS = mean(IS_data.ExcessReturn_t1, 'omitnan'); % 相同基準
